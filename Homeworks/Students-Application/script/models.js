...
app.models = (function () {
	...
	var Requester = (function () {
		...
		function makeRequest (method, url, data, success, error) {
			$.ajax({
				method: method,
				headers: {
					'X-Parse-Application-Id': '6kIP1tcIBFuLtSVuD4CmqJ1w4k8z8vSmWge7PGJj'
					'X-Parse-REST-API-Key': 'uGEwR2Ibv5b9otLhgAocAqnLRmSS23RCmaIhQoYf'
				},
				url: url,
	...
	var Students = (function () {
		...
		Students.prototype.postStudent = function(student, error) {
